...
/***
 * Use this class to generate random numbers and send them into the device service as if a sensor was sending the data.
 * Requires the Device Service along with Mongo, Core Data, and Metadata to be running
 *
 */
public class TestMQTTDeviceSendor {
	...
	private static String MQTT_USER = "vyrnnobp";
	private static String MQTT_PASS="q4u83TLxjCaI";
	...
	public static void main(String[] args) throws InterruptedException {
		...
		double random;
		OutgoingSender sender = new OutgoingSender(address, MQTT_CLIENT_ID, MQTT_USER, MQTT_PASS, MQTT_TOPIC);
		while (true){
