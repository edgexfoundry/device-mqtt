...
public class IncomingListener implements MqttCallback {
	...
	private final static Logger logger = Logger.getLogger(IncomingListener.class);
	...
	private void startListening() {
		...
		try {
			String url = incomingMQTTBrokerProtocol + "://" + incomingMQTTBroker + ":" + incomingMQTTBrokerPort;
